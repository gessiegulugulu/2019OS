...
public class Folder extends FCB
{
	...
	class FolderViewPanel extends JPanel
	{
		void setViewPanel()
		{
			...
			viewPanel.setBounds(30, 40, 40, 40);
		...
		MouseListener viewMouseListener=new MouseListener()
		{
			...
			public void mouseClicked(MouseEvent e)
			{
				...
				else if (e.getButton()==MouseEvent.BUTTON3)
				{
					...
					openMenu.setBackground(Color.WHITE);
					openMenu.setForeground(Color.BLACK);
					openMenu.addActionListener(openMenuListener);
					menu.add(openMenu);

					JMenuItem resetNameMenu=new JMenuItem("重命名");
					resetNameMenu.setBackground(Color.WHITE);
					resetNameMenu.setForeground(Color.BLACK);
					...
					deleteMenu.setForeground(Color.BLACK);
					...
					else
					{
						...
						showMenu.setForeground(Color.BLACK);
						showMenu.addActionListener(showMenuListener);
						menu.add(showMenu);
					}

					JMenuItem propertyMenu=new JMenuItem("属性");
					propertyMenu.setBackground(Color.WHITE);
					propertyMenu.setForeground(Color.BLACK);
